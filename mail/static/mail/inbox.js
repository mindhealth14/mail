      ...
      .then(emails => {
          ...
          for (let i of Object.keys(emails)) {
              ...
              elem_email.innerHTML = `
                            <div class="row"> 
                                <div class="col-3 pl-5">${mailbox === 'sent' ? 'To: ' + emails[i].recipients : 'From: ' + emails[i].sender}</div>
                                <div class="col-6">Subject: ${emails[i].subject}</div>
                                <div class="col-3">Date: ${emails[i].timestamp}</div>
                            </div>
                        `;
